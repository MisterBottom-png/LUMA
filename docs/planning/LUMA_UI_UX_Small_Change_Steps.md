...
- [ ] Remove all internal AI IDs from the UI (`task:5`, `capture:26`).
- [ ] Create reusable Source Row component.
- [ ] Replace FilterChips with Source Rows.
- [ ] Hide non-functional microphone on Home.
- [ ] Hide unavailable Monday integration actions.
- [ ] Remove every dead/non-working control.
- [ ] Add fixed Situation AI header.
- [ ] Make Situation AI body independently scrollable.
- [ ] Pin Ask LUMA composer above keyboard.
- [ ] Fix Android Back behavior for Situation AI.
- [ ] Prevent keyboard from covering content.
- [ ] Replace Ask button with embedded send icon.
- [ ] Add loading state to Ask composer.
- [ ] Support IME Send action.
- [ ] Clear stale AI responses after question changes.
- [x] Separate Review modes from Open Loops workflow.
- [x] Make Review items tappable.
