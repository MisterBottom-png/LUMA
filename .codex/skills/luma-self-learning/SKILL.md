...
description: Use after every medium or large LUMA task to extract lessons, update project memory, update regression checks, record bugs, and propose permanent rule improvements without directly rewriting AGENTS.md.
---
...
Good:
Detailed calendar controls should live outside Home so Home stays calm.
```

## Promotion rule

If a lesson should become a permanent rule, add it to:
...
```md
## Proposed permanent rule: <name>

Rule:
<exact rule text>

Reason:
<why this should become permanent>

Evidence:
<task or bug that revealed this>

Suggested destination:
AGENTS.md / LUMA_RULES.md / other
